        ...
        expected = _create_expected({
            ...
            EdgeTypes.Description.value: [
                {'created': created_at, '~from': f'{get_shard()}:Column:Snowflake://production.esikmo/igloo/block1',
                 '~to': f'{get_shard()}:Description:Snowflake://production.esikmo/igloo/block1/user/_description'},
                {'created': created_at, '~from': {'~label': 'Table', 'key': 'Snowflake://production.esikmo/igloo'},
                 '~to': {'~label': 'Description', 'key': 'Snowflake://production.esikmo/igloo/other/_description'}},
                {'created': created_at, '~from': {'~label': 'Table', 'key': 'Snowflake://production.esikmo/igloo'},
                 '~to': {'~label': 'Description', 'key': 'Snowflake://production.esikmo/igloo/user/_description'}}],
            VertexTypes.Description.value: [
                {'description': 'won', 'key': 'Snowflake://production.esikmo/igloo/block1/user/_description',
                 'source': 'user'},
                {'description': 'super ' 'cool', 'key': 'Snowflake://production.esikmo/igloo/other/_description',
                 'source': 'other'},
                {'description': "it's " 'cool', 'key': 'Snowflake://production.esikmo/igloo/user/_description',
                 'source': 'user'}],
